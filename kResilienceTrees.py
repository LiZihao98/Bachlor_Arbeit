...
if __name__ == "__main__":
    ...
    while failpercent <= 0.9:
        print(failpercent)
        main(repeats, 8, no_nodes, failureModel="clustered", treeChoice="edgeCount", edgeFailFactorPar=0, failurePercentPar=failpercent, failureDropPar=0.3, draw=False, graphMLpath = graphMLpaths[5])
        failpercent += 0.1
